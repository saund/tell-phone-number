...
#This backup of 2016/06/25 uses  data_index_pointer. This will be obsoleted
#in favor of a more precise belief model of what part of the data model is
#being referred to by utterances.

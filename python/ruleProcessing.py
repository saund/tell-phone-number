...
#
#Instead of treating digit strings of different lengths as separate utterance category
#rules with different numbers of arguments, there should probably be a special purpose
#rule to collect up sequences of digit or alphanumeric words.
#i.e. instead of
#InformTopicInfo(ItemValue(DigitSequence($1, $2, $3, $4))) <-> {DigitCat[$1]} {DigitCat[$2]} {DigitCat[$3]} {DigitCat[$4]}
#make it
#InformTopicInfo(ItemValue(DigitSequence($1)) <-> {DigitSequenceCat[$1]} 
#where the DigitSequenceCat parses   "six five zero" as a single string arugment for the slot $1
#
